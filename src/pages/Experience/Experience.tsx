...
const EXPERIENCE_ITEMS: ExperienceItem[] = [
  {
    ...
    role: "Responsable de IT & Full Stack Developer (Team Lead)",
    bullets: [
      "Desarrollo completo de MindScan, plataforma SaaS de análisis psicológico con diagnósticos, informes, perfiles comparativos, control de roles y panel de administración.",
      "Implementación de backend con Node.js, Express, Prisma y PostgreSQL.",
      "Desarrollo frontend con React, TypeScript, TailwindCSS.",
      "Migración de la web corporativa a un stack moderno con Astro, optimizando rendimiento y publicación de contenido.",
      "Puesta en marcha de una PWA de seguimiento formativo (prototipo funcional).",
      "Automatización del despliegue con GitHub Actions, scripts personalizados y CI/CD.",
      "Gestión de servidores: Ubuntu, NGINX, PM2, VPS, certificados SSL.",
      "Integraciones con Cloudinary y OpenAI API.",
      "Soporte TI a empleados (hardware/software, incidencias, preparación de equipos).",
      "Establecimiento de metodologías ágiles y documentación interna.",
      "Contratación y formación de dos desarrolladores junior.",
    ],
    tech: [
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    role: "Full Frontend Developer (Bootcamp +800h)",
    bullets: [
      "Proyecto real desarrollado para una ONG enfocada en inserción laboral.",
      "Coordiné parte del equipo (9 personas) y fui responsable principal del diseño visual y estilos.",
  ...
  },
  {
    ...
    role: "Técnico de sistemas informáticos (Prácticas)",
    bullets: [
      "Soporte técnico a usuarios: instalación de software y diagnóstico de equipos.",
      "Mantenimiento preventivo y resolución de incidencias.",
      "Instalación y actualización de sistemas y periféricos.",
    ],
    tech: ["Soporte técnico", "Hardware", "Software", "Redes"],
  },
];
